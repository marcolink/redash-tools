...
const createParameter = (
  subParameters: Pick<OptionParameters, 'name' | 'value' | 'type'>
): OptionParameters => {
  return {
    locals: [],
    global: false,
...
describe('a parseOptionParameters function', () => {
  ...
  it('can parse options with a "text" type parameter', () => {
    ...
    expect(parseOptionParameters([parameter])).toEqual({
  ...
  describe('can parse options with a "date-range" type parameter', () => {
    it('and return "this week" date range', () => {
      ...
      expect(parseOptionParameters([parameter])).toEqual({
        dateRangeType: { start: '1980-01-27', end: '1980-02-02' },
      });
    });
    it('and return "this month" date range', () => {
      ...
      expect(parseOptionParameters([parameter])).toEqual({
        dateRangeType: { start: '1980-02-01', end: '1980-02-02' },
      });
    });
    it('and return "this year" date range', () => {
      ...
      expect(parseOptionParameters([parameter])).toEqual({
        dateRangeType: { start: '1980-01-01', end: '1980-02-02' },
      });
    });
    ...
    it('and return a last 7 days date range', () => {
      ...
      expect(parseOptionParameters([parameter])).toEqual({
        dateRangeType: { start: '1980-01-26', end: '1980-02-02' },
      });
    });
    ...
    it('and return "last month" date range', () => {
      ...
      expect(parseOptionParameters([parameter])).toEqual({
        dateRangeType: { start: '1980-01-01', end: '1980-01-31' },
      });
    });
    ...
    it('and return "last year" date range', () => {
      ...
      expect(parseOptionParameters([parameter])).toEqual({
        dateRangeType: { start: '1979-01-01', end: '1979-12-31' },
      });
    });
  });
});
